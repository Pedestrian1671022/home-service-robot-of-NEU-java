...
public class MapPosePublisherLayer extends DefaultLayer {
	...
	public MapPosePublisherLayer(final Context context,
		...
		this.mapFrame = RobotItemActivity.static_robotItem.getMap_topic();
		this.robotFrame = (String) appParameters.get("robot_frame", "base_link");

		this.initialPoseTopic = RobotItemActivity.static_robotItem.getInitial_pose_topic();
		this.simpleGoalTopic = RobotItemActivity.static_robotItem.getSimple_goal_topic();
		this.moveBaseGoalTopic = RobotItemActivity.static_robotItem.getGoal_topic();
	}
